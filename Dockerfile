# См. deploy/Dockerfile — канонический прод-образ (UI + бинарники MCP), тег sdocs-mcp-ui:0.6.8.
# Из корня: docker build -f deploy/Dockerfile -t sdocs-mcp-ui:0.6.8 .  |  из этого файла: docker build -t sdocs-mcp-ui:0.6.8 .
#
...
LABEL org.opencontainers.image.version="0.6.8"
