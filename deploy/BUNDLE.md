# Готовый комплект `sdocs-mcp` (релиз 0.6.2)
...
| `deploy/Dockerfile` | Образ `sdocs-mcp-ui:0.6.2`: `sdocs-mcp-ui`, `sdocs-mcp`. |
...
На целевой машине: `docker load -i deploy/sdocs-mcp-ui-0.6.2.tar`.
