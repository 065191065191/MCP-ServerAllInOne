# Готовый комплект `sdocs-mcp` (релиз 0.6.0)
...
| `deploy/Dockerfile` | Образ `sdocs-mcp-ui:0.6.0`: `sdocs-mcp-ui`, `sdocs-mcp`. |
...
На целевой машине: `docker load -i deploy/sdocs-mcp-ui-0.6.0.tar`.
