# Готовый комплект `stack-mcp-server` (релиз 0.3.2)
...
| `deploy/Dockerfile` | Образ `stack-mcp-ui:0.3.2`: `stack-mcp-ui`, `stack-mcp`. |
...
На целевой машине: `docker load -i deploy/stack-mcp-ui-0.3.2.tar`.
