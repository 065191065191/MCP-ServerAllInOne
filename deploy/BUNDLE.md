# Готовый комплект `stack-mcp-server` (релиз 0.2.5)
...
| `deploy/Dockerfile` | Образ `stack-mcp-ui:0.2.5`: `stack-mcp-ui`, `stack-mcp`. |
...
На целевой машине: `docker load -i deploy/stack-mcp-ui-0.2.5.tar`.
